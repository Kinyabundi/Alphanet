import { createMEVDetectionTool } from './agents/tools/mevDetection/index.js';
...
const orchestratorConfig = async (): Promise<OrchestratorRunnerOptions> => {
  ...
  const mevDetectionTool = createMEVDetectionTool();
  ...
  return {
    ...
    tools: [twitterAgentTool, ...webSearchTool, mevDetectionTool],
    prompts,
    saveExperiences,
    monitoring: {
      enabled: monitoringEnabled,
